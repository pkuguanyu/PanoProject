...
#1.对于同一个视频，观察离开比较高的点的头部 头部运动方向改变情况，计算其平均运动方向改变次数，也观察离开适中的点，观察期平均运动角度

gap=5
path="D:/2018.3.27/PeakLeaving_"+str(gap)+"s/"
path2="C:/Aiqiyi/new_iqiyi_final/1_"+str(gap)+"s/"
outpupath="D:/2018.3.27/AverageAngle/ComparasionHigh_"+str(gap)+"s/" #记录高离开率的动作信息
outpupath2="D:/2018.3.27/AverageAngle/ComparasionNormal_"+str(gap)+"s/" #记录正常离开率的动作信息
